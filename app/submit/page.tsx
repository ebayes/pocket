...
export default function IndexPage() {
  ...
  return (
    <section className="items-between pt-10">
      ...
      <Card className="flex flex-col w-[95vw] sm:w-[50vw] h-[50vh] translate-y-10 bg-white bg-opacity-95">
      <CardHeader>
      ...
      <div className="flex items-center space-x-2">
          ...
          <ScrollArea className="h-[150px] sm:h-[200px] rounded-md pb-3 pr-1">
